...
- Agregar `ClearDatabanks` sobre `Results` (465 estrategias que no pasaron el primer filtro OOS, ya respaldadas en el bruto — seguro limpiarlas). A decidir si va antes de este primer Retest (para no ocupar memoria durante la corrida) o después.
